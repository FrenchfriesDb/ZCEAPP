export const SUCCESS_MESSAGES = [
    "Zane says: CERTAINTY. You spoke before the clock. That’s a win. Next round.",
    "Zane says: Fast. You didn't choke. Now, let's see if it was good. Next.",
    "Zane says: High-Status Speed. You owned that 4 seconds, Pretty. Keep going.",
    "Zane says: That was hard to top, great job. You didn't overthink it. Next round.",
    "Zane says: Good. That's the sound of flow. Don't let the thought creep in. Next.",
    "Zane says: Instinct. That wasn't thought; that was reflex. Your Head and Heart are aligning.",
    "Zane says: **UNREADABLE.** You gave them something they didn't expect. Keep that mystery.",
    "Zane says: Warmth achieved. Your tone was slow and low. That’s high-status conversation. Next round.",
    "Zane says: Truth + Energy + Timing. The formula hit. Don't analyze it; just repeat the feeling.",
    "Zane says: You filled the space. Silence belongs to the brave. You owned it. Next.",
    "Zane says: You turned the pressure into play. That's the difference between a Pretty and a Zane-la.",
...
export const SPEED_PROMPTS = [
    "Someone says: 'Do you use ChatGPT to do your homework?'",
    "Someone asks: 'Why are you so quiet today?'",
    "Someone teases: 'Nice shoes. Did your mom pick those out?'",
    "Someone says: 'You look tired.'",
    "Someone asks: 'What do you do for fun?'",
    "Someone says: 'You're always on your phone.'",
    "Someone asks: 'Why don't you talk more?'",
    "Someone teases: 'Wow, you actually showed up on time for once.'",
    "Someone asks: 'Are you okay? You seem off.'",
    "Someone says: 'That's a weird hobby.'",
    "Someone asks: 'Do you even go outside?'",
    "Someone says: 'You're pretty smart, huh?'",
    "Someone teases: 'Is that really what you're wearing?'",
    "Someone asks: 'Why are you always by yourself?'",
    "Someone says: 'You must have no life if you have time for that.'",
    "Someone yells: 'OH NO MS. MAHONY LOOKS LIKE SOMEONE'S LATE!! BETTER LUCK NEXT TIME SKIPPER!'",
    "A group of friends is laughing. You walk up. They stop. One says: 'What are you even doing here?'",
    "You try a Zane-style joke. It falls flat. Your friend says, 'Bro, that was cringe. You practicing in the mirror again?'",
    "You ask someone out, and they look confused: 'Wait, are you serious? I thought you were just the quiet kid.'",
    "Your coach benches you again. You complain, 'I play harder and hit faster.' The coach says, 'Show me consistency, not flashes.'",
    "You're silent at a table. Someone asks: 'Why are you so quiet? You must not have anything interesting to say.'",
    "Someone gives you a compliment: 'Wow, you have a great, deep voice.'",
    "You are told your ambition is ridiculous: 'Ivy League? You have B's. Give up, kid.'",
    "You are sitting alone. Someone approaches and asks: 'What heavy thoughts are you trying to solve over here?'",
    "A girl bumps into you in the hall and says: 'Watch where you're going, Pretty.'",
    "You make eye contact with the class clown. He grins and whispers to his friend, 'Look, the mysterious one decided to blink.'",
    "You tell a classmate about the ZCE app. They laugh and say, 'An app to teach you how to talk? Just go outside, loser.'",
    "A group is loudly arguing about a bad call in a basketball game. You cut into the middle of the debate. What's your first line?",
    "Someone you respect asks you directly: 'You're quiet, intense, and always working. Are you even having fun?'",
    "You accidentally bump into the school's most popular girl. She gives you a slow, judgmental stare without saying a word. Respond.",
    "You’re asked to present your ZCE idea to a teacher. They interrupt: 'That sounds like a waste of time. Why don't you focus on your B in English?'",
    "Your basketball team loses badly. A teammate blames you: 'You overthink everything! Why didn't you just pass?'",
    "You see a girl wearing a T-shirt for a very niche band/game you secretly love. How do you approach her and start a conversation?",
    "Someone tries to interrupt you while you're talking. You keep talking over them, but gently. What do you say to the crowd to regain control?",
    "You try the 'Zane Whisper Drill' on a friend. They pull back and ask: 'Why are you talking like that? Are you trying to sound sexy?'",
    "You're in a conversation with someone who's talking about their favorite book. They ask, 'What's your favorite book?'",
    "'Stop or else I'm going to short your portfolio'. Respond.",
    "'Bet, it's already going down'. Respond.",
    "'You're so uncool'. Respond.",
    "'You're nonchalant/chalant'. Respond.",
    "Someone walks up to you and shuts down your laptop. Respond.",
    "'[Y/N] [Y/N] my queen queen.' Respond"
];

export const LINK_WORDS = [
    'Tennis', 'Wi-Fi', 'Coffee', 'Monday', 'Laptop', 'Rain', 'Music', 'Math',
    'Pizza', 'Teacher', 'Phone', 'Sleep', 'Homework', 'Cat', 'Dance', 'Book',
...
export const FLIP_PROMPTS = [
    "Someone says you look tired",
    "Someone teases your outfit choice",
    "Someone asks why you're so quiet",
    "Someone says your hobby is weird",
...
export const OBJECTS = [
    ...
    "An empty fridge", "A pair of Crocs", "A 1% battery warning"
];
